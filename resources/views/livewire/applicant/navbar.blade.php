...
<div class="container-fluid p-0">
        ...
        <div class="col position-relative" style="z-index:5;">
            <a wire:navigate href="{{ route('applicant.home') }}">
                <div
                    ...
                    <div href="" class="{{ request()->routeIs('applicant.home') ? 'text-white' : 'text-primary' }}"><i
                            class="fas fa-edit"></i>
    ...
    <div class="row g-0 justify-content-end mt-2">
        <div class="col-auto">
            <a href="{{ route('login') }}" target="_blank" class="btn btn-primary px-4 fw-bold"
                style="border-radius: 5px 0px 0px 5px; background-color: #003371; border-color: #003371; color: white;">
                <i class="fas fa-sign-in-alt me-2"></i> Authorized Personnel Login
            </a>
        </div>
    </div>
</div>
